...
from qqmusicbox.singleton import Singleton
        ...
        while True:
            ...
            if new_url:
                ...
                if self._is_cache_successful():
                    log.debug(str(song_mid) + " Cache OK")
                    onExit(song_mid, full_path)
        self.download_lock.release()

    def add(self, song_mid, song_name, artist, url, onExit):
        self.check_lock.acquire()
        self.downloading.append([song_mid, song_name, artist, url, onExit])
        self.check_lock.release()

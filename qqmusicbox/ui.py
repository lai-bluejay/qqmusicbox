...
class Ui(object):
    ...
    def build_playinfo(
        self, song_name, artist, quality, start, pause=False
    ):
        curses.noecho()
        # refresh top 2 line
    ...
    def build_menu(self, datatype, title, datalist, offset, index, step, start):
        ...
        if datatype == "main":
            ...
            self.addstr(20, 6, "QQMUSIC-MusicBox 基于Python，所有版权音乐来源于网易，本地不做任何保存")
